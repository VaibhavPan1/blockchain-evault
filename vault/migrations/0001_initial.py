    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('judge', 'Judge'), ('lawyer', 'Lawyer')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action', models.CharField(choices=[('viewed', 'Viewed'), ('downloaded', 'Downloaded'), ('decrypted', 'Decrypted')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='vault.file')),
            ],
        ),
        migrations.CreateModel(
            name='FileKey',
